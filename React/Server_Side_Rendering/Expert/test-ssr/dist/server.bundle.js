...
function App(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(Container, null, /*#__PURE__*/_react["default"].createElement("button", {
    ...
    src: _icon["default"]
  }), /*#__PURE__*/_react["default"].createElement(PageComponent, null));
}
...
app.get('*', function (req, res) {
  ...
  var result = html.replace('<div id="root"></div>', "<div id=\"root\">".concat(renderString, "</div>")).replace('__DATA_FROM_SERVER__', JSON.stringify(initialDate)).replace('__STYLE_FROM_SERVER__', styles);
  res.send(result);
});
app.listen(3000);
})();
